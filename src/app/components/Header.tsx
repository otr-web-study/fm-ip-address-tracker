...
export const Header: React.FC<HeaderProps> = ({ onSearch }) => {
  ...
  return (
    <header className="bg-mobile md:bg-desktop flex min-h-[300px] flex-col items-center gap-[23px] bg-cover px-6 pt-[26px] md:min-h-[280px] md:gap-[28px] md:pt-[30px]">
      ...
      >
        ...
        <button
          type="submit"
          className="bg-icon-arrow bg-very-dark-gray bg-center bg-no-repeat p-[29px] transition-opacity duration-300 hover:opacity-90"
        />
      </form>
    </header>
  );
